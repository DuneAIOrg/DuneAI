...
const installFactories = (factories, projectDir) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    factories.forEach((factory) => {
        ...
        if (fs.existsSync(srcFactoryDir)) {
            ...
            console.error(chalk.red(`Factory ${factory} does not exist in the repository`));
        }
    });
...
function setup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const inquirerSearchCheckbox = (yield Promise.resolve().then(() => __importStar(require("inquirer-search-checkbox"))))
            .default;
        const chalkAnimation = (yield Promise.resolve().then(() => __importStar(require("chalk-animation")))).default;
        ...
        program
            ...
            .option("-e, --example", "Include default example 'Hello World' skeleton", true)
        ...
        program.on("--help", () => {
            ...
            console.log("                                    Example: --name myProject");
            console.log("");
            console.log("  -o, --output <outputDir>          Output directory for the project");
            console.log("                                    Default: Camel case version of the project name");
            console.log("                                    Example: --output ./myProjectDir");
            console.log("");
            console.log("  -w, --worm                Include WORM in the project");
            console.log("                                    Default: false");
            console.log("                                    Example: --worm");
            console.log("");
            console.log("  -a, --adapters <adapters>         Include specified adapters in the project");
            console.log("                                    Example: --adapters GPT4ALL,AI,SD");
            console.log("");
            console.log("  -f, --factories <factories>       Install specified factories in the project");
            console.log("                                    Example: --factories Factory1,Factory2");
            console.log("");
            console.log("  -p, --providers <providers>       Include specified providers in the project");
            console.log("                                    Example: --providers OpenAI,Anthropic");
            console.log("");
            console.log("  -e, --example                     Include default example 'Hello World' skeleton");
            ...
            console.log("  $ setup --name myProject --adapters GPT4ALL,AI --factories Factory1,Factory2");
            console.log("  $ setup --help");
            console.log("");
            console.log("For more information, visit https://github.com/KenanKStipek/DuneAI");
        });
        program.parse(process.argv);
        const options = program.opts();
        const https = require("https");
        const availableFactories = yield new Promise((resolve, reject) => {
            https
                .get("https://raw.githubusercontent.com/DuneAIOrg/Factories/main/index.json", (res) => {
                let data = "";
                res.on("data", (chunk) => {
                    data += chunk;
                });
        ...
        const askQuestions = () => __awaiter(this, void 0, void 0, function* () {
            const questions = [];
            if (!options.name) {
                questions.push({
                    type: "input",
            ...
            if (!options.output) {
                questions.push({
                    ...
                    default: (answers) => answers.factory
            ...
            questions.push({
                type: "confirm",
                name: "worm",
                message: "Would you like to include and use WORM (Workflow Orchestration and Regenerative Monitor)?",
                default: false,
            ...
            questions.push({
                type: "confirm",
                name: "example",
                message: "Would you like to include the example 'Hello World' orchestration?",
                default: false,
                when: (answers) => !answers.factory,
            });
            questions.push({
            ...
            return Object.assign(Object.assign({}, options), answers);
        });
        const createProjectStructure = (projectName, outputDir, adapters, factories, providers, typescript, worm, example, factory) => __awaiter(this, void 0, void 0, function* () {
            try {
...
This is a test, please respond.
      `;
                        fs.writeFileSync(path.join(projectDir, "src", "Prompts.prompt"), promptsContent);
...
(async () => {
  ...
  console.log({ result });
            ...
            `;
                        fs.writeFileSync(path.join(projectDir, "src", typescript ? "index.ts" : "index.js"), indexContent);
                    }
                    else {
                    ...
                    yield installDependencies(projectDir, adapters, providers, typescript);
                    const adapterRequirements = adapters.includes("GPT4ALL") &&
                        `If you haven't already, install and configure GPT4ALL. More information here: https://github.com/nomic-ai/gpt4all `;
                    const envRequirements = providers !== "." &&
      ...
      `;
            ...
            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                ...
                createProjectStructure(answers.projectName, answers.output, answers.adapters, answers.factories, answers.providers, answers.typescript, answers.worm, answers.example, answers.factory);
            }), 450);
        });
        runSetup();
    });
